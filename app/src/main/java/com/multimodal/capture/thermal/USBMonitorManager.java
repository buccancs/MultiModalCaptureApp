...
public class USBMonitorManager {
     ...
     */
    public void init(Context context, int pid, boolean isUseIRISP, CommonParams.DataFlowMode defaultDataFlowMode) {
        this.mPid = pid;
        ...
        if (mUSBMonitor == null) {
            mUSBMonitor = new USBMonitor(context,
    ...
    private void startPreview() {
        ...
        // Notify listeners that initialization is complete and preview is starting
        for (OnUSBConnectListener listener : mOnUSBConnectListeners) {
